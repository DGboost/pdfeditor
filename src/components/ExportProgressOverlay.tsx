import { spinnerAccentStyle } from '../styles/theme';
...
export function ExportProgressOverlay({ progress }: ExportProgressOverlayProps) {
  ...
  return (
    <div style={{
      position: 'fixed', inset: 0, background: 'oklch(20% 0.01 250 / 55%)', zIndex: 90,
      display: 'flex', alignItems: 'center', justifyContent: 'center',
    }}>
      <div style={{
        background: '#fff', borderRadius: 14, padding: '28px 36px', display: 'flex', flexDirection: 'column',
        ...
        <div style={{ fontSize: 12.5, color: 'oklch(50% 0.02 250)', fontFamily: "'Pretendard',sans-serif" }}>
